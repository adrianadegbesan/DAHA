...
struct PasswordResetButton: View {
    ...
    var body: some View {
        ...
        .alert("Error sending Email", isPresented: $error_alert, actions: {}, message: { Text("Please check the email you entered and your network connection then try again later")})
    }
}
